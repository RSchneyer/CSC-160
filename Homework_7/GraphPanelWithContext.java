...
public class GraphPanelWithContext extends JPanel
{
   ...
   */
   public GraphPanelWithContext(ToolBar aToolBar, Graph aGraph)
   {
      toolBar = aToolBar;
      graph = aGraph;
